...
- [工程目录](#) - `分布式服务工程`、`前端工程`、`运营后台`、`技术组件`、`测试工程`
...
| 2 | <img src="https://codechina.csdn.net/uploads/-/system/project/avatar/79776/%E7%94%A8%E6%88%B7%E7%BB%84.png" width="64px"> | C端用户系统 | [Lottery-Front](https://codechina.csdn.net/KnowledgePlanet/Lottery-Front) | 开发中，提供；vue H5 页面抽奖、公众号开发回复消息抽奖。 |
| 3 | <img src="https://codechina.csdn.net/uploads/-/system/project/avatar/79714/%E8%BF%90%E8%90%A5%E9%A2%84%E6%9C%9F.png" width="64px"> | B端运营系统 | [Lottery-ERP](https://codechina.csdn.net/KnowledgePlanet/Lottery-ERP) | 满足运营人员对于活动的查询、配置、修改、审核等操作。 |
| 4 | <img src="https://codechina.csdn.net/uploads/-/system/project/avatar/67564/%E6%95%B0%E6%8D%AE%E5%BA%93.png" width="64px"> | 分库分表路由组件 | [db-router-spring-boot-starter](https://codechina.csdn.net/KnowledgePlanet/db-router-spring-boot-starter) | 开发一个基于 HashMap 核心设计原理，使用哈希散列+扰动函数的方式，把数据散列到多个库表中的组件，并验证使用。 |
| 5 | <img src="https://codechina.csdn.net/uploads/-/system/project/avatar/58903/%E6%B5%8B%E8%AF%95.png" width="64px"> | 测试验证系统 | [Lottery-Test](https://codechina.csdn.net/KnowledgePlanet/Lottery-Test) | 用于测试验证RPC服务、系统功能调用的测试系统。 |
